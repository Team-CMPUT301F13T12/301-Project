...
//        myActivity = getActivity();
        ...
        /*
         * fragment = new Fragment(); fragment.setTitle("Start Frag"); story =
         * new Story(); List<Fragment> fragments = story.getFragments();
         * fragments.add(fragment); storyList = new StoryList();
         * storyList.addStory(story); storyListController =
         * AdventureCreator.getStoryListController(); //save story
         * storyListController.saveOfflineStories(storyList); //set up intent
         * Intent FragmentIntent = new Intent(); FragmentIntent.putExtra("Mode",
         * "Edit"); FragmentIntent.putExtra("StoryPos", 0);
         * FragmentIntent.putExtra("FragmentPos", 0);
         * setActivityIntent(FragmentIntent); myEditFragmentActivity =
    ...
    //
    // // Use Case 11 1/2
    // // User enables adding illustrations by adding the first one to a
    // fragment
    ...
    // * someFragment.getAnnotation().getPhotos().size());
    // */
    // assertTrue("testPostPhotoToAnnotateFragment has not yet been implemented",
    // false);
    // }
    //
    // // test case 12
