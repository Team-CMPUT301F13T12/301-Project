...
public class StoryFragmentControllerTestCases extends TestCase {
    ...
    public void testaddNewFragmentPart() {
        ...
        assertTrue(myList.get(0).equals("t"));
    ...
    public void testDeleteStory() {
        ...
        sf = new Fragment();
        //fc.addNewFragmentPart(sf, "Text", 0);
        fc.addNewFragmentPart(sf, "Text", 0);
    ...
    public void testInsertIllustration() {
        sf = new Fragment();
      //(sf, "illustration1", 0);
        fc.addNewFragmentPart(sf, "illustration1", 0);
    ...
    public void testAddChoice() {
        ...
        //fc.addChoice(sf, c);
        fc.getLinkedToFragmentPosOfChoice(sf, 0);
        assertTrue(sf.getParts().get(0).getChoice().equals("Test"));
    }
