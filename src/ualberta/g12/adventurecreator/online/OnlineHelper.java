...
public class OnlineHelper {
	 ...
	 * an object with an already existing id will overwrite it. To check if there is an Id 
	 * that has been taken you can use the checkId method.
	 * 
	 ...
	 * of the object. Will search only the storyTitle, author and Id of a story and return
	 * only those fields. This is why getFields method is used for each ElasticSearchReponse
	 ...
	 * prevent the case of accidental overwriting. Story Ids are obtained by hashing 
	 * a string that is the title and author combined. Method is mainly used when the user 
	 * wants to publish a story to ensure that they know if a story will be overwritten. 
	 * 
	 ...
	 * "search" string. Right now this method is used for our searching function in the
	 *  online story mode browser. Users will type in keywords which will become the input 
	 *  parameter to this method. 
	 *  
	 *  For Example searchsearchStories("David Fight") will search the stories that contain "David" and "Fight"
	 *  within the title and author fields.
	 * 
	 ...
	 * server.
	 * As of right now this method is not used in the main program yet, but should be implemented to let users delete published stories from the web server.
	 * 
	...
	/**
	 * This method is used to get the http response from our server and convert it to a string.
	 * 
	 * For example the response from a server may look something like this:
	 * 
	 * 		{
	 *			"_index" : "cmput301f13t12",
	 *			"_type" : "stories",
	 *			"_id" : "-1519474429",
	 *			"_version" : 1,
	 *		"	exists" : true, "_source" : {"author":"op","fragments":[{"title":"Story Start Fragment","parts":[],"id":0,"views":[]}],"storyTitle":"testing 321","startFragPos":0,"id":-1519474429,"views":[]}
	 *		}
     *
	 * @param response is the http response that is obtained from the server from some query
